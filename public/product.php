...
// (เพื่อให้ footer.php โหลด reCAPTCHA key ได้)
require_once __DIR__ . '/../config/db_connect.php';

// 2. (สำคัญ) ตั้งค่า Meta Tags สำหรับหน้านี้
// (ผมดึงมาจากโค้ดเก่าของคุณ)
...
<section id="page-hero" class="relative overflow-hidden bg-gray-900 lg:min-h-[calc(100vh-5rem)] text-white overflow-hidden">
        ...
        <div id="page-hero-content" 
            ...
            <p class="font-kanit text-xl mt-4 max-w-2xl mx-auto text-shadow">
                เราคัดสรรและพัฒนาผลิตภัณฑ์คุณภาพสูง <br> เพื่อตอบสนองทุกความต้องการในอุตสาหกรรม
            </p>
        </div>
    </section>
    ...
    <section id="product-list" class="bg-light py-16 sm:py-24 overflow-hidden">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <?php
                // (ผมแปลงข้อมูลสินค้าจากโค้ดเก่าของคุณมาเป็น Array เพื่อให้จัดการง่าย)
                $products = [
                    [
...
// (จะโหลด <script> ทั้งหมด รวมถึง main.js ให้อัตโนมัติ)
include 'footer.php';
?>